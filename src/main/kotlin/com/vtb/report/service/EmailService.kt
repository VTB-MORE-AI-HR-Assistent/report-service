...
class EmailService(
    ...
    fun sendRecommendationEmail(emailRequest: EmailRequestDTO, recommendation: CandidateRecommendation) {
        ...
        helper.setFrom("noreply@hraiassistant.ru")
        helper.setTo(emailRequest.recipientEmail)
        helper.setSubject("Candidate Recommendation - VTB AI HR System")
        helper.setText(generateRecommendationEmailHtml(recommendation, emailRequest.recipientName), true)
